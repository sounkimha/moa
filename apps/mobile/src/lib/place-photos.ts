...
const citySpecificPhotos: Record<string, PlacePhoto> = {
  라스베이거스: commonsPhoto('미국 · 라스베이거스 스트립', 'https://thumb.wikimedia.org/wikipedia/commons/thumb/8/8b/Las_Vegas_Strip.png/960px-Las_Vegas_Strip.png?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail', 'https://commons.wikimedia.org/wiki/File:Las_Vegas_Strip.png'),
